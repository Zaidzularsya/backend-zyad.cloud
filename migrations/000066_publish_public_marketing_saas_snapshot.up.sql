-- Republish the platform's public-marketing landing page snapshot so the restructured SaaS
-- content (000065) is served by the public resolve endpoint, which reads from the latest
-- landing_page_versions snapshot rather than live landing_page_sections rows once a page has
...
SELECT
	...
	lp.id,
	nv.version,
	'Seed: republish with restructured SaaS platform content',
	jsonb_build_object(
