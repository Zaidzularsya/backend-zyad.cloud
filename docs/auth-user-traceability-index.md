...
| Register by admin | 1.B Register | USER-0203 | `POST /admin/users` | `users`, `user_profiles` | planned |
...
| Approval admin | 1.B Register | USER-0207 | Status endpoints | `users.status` | planned |
...
| Forgot password | 1.D Forgot Password | AUTH-0105 | `POST /auth/forgot-password` | `password_reset_tokens` | planned |
| Validate reset token | 1.D Forgot Password | AUTH-0106 | `POST /auth/reset-password/validate` | `password_reset_tokens` | planned |
| Reset password | 1.D Forgot Password | AUTH-0107 | `POST /auth/reset-password` | `password_reset_tokens`, `users.password_hash` | planned |
| Change password | 1.E Change Password | AUTH-0108 | `POST /auth/change-password` | `users.password_hash` | planned |
| Password history | 1.E Change Password | AUTH-0108 | Change password validation | Future `password_histories` table | deferred |
| Password policy | 1.E Change Password | AUTH-0108 | Validation errors | Config | planned |
...
| List user | 2.A User CRUD | USER-0201 | `GET /admin/users` | `users` | planned |
| Detail user | 2.A User CRUD | USER-0202 | `GET /admin/users/:id` | `users`, related tables | planned |
| Create user | 2.A User CRUD | USER-0203 | `POST /admin/users` | `users` | planned |
| Update user | 2.A User CRUD | USER-0204 | `PATCH /admin/users/:id` | `users`, `user_profiles` | planned |
| Delete user | 2.A User CRUD | USER-0205 | `DELETE /admin/users/:id` | `users.deleted_at` | planned |
| Restore user | 2.A User CRUD | USER-0205 | `POST /admin/users/:id/restore` | `users.deleted_at` | planned |
| Bulk delete | 2.A User CRUD | USER-0206 | `POST /admin/users/bulk-action` | `users.deleted_at` | planned |
| Bulk update status | 2.A User CRUD | USER-0206 | `POST /admin/users/bulk-action` | `users.status` | planned |
...
| User status | 2.C User Status | USER-0207 | Status endpoints | `users.status` | planned |
...
| Notification integration | 5 Notification Integration | AUTH-0105, AUTH-0304, AUTH-0402 | Not public | mail/whatsapp platform | planned |
...
| Middleware | 13 Middleware | USER-0213 | Protected endpoints | None | planned |
...
| --- | --- | --- |
| `POST /auth/login` | AUTH-0101 | planned |
...
| `POST /auth/forgot-password` | AUTH-0105 | planned |
| `POST /auth/reset-password/validate` | AUTH-0106 | planned |
| `POST /auth/reset-password` | AUTH-0107 | planned |
| `POST /auth/change-password` | AUTH-0108 | planned |
...
| `GET /admin/users` | USER-0201 | planned |
| `GET /admin/users/:id` | USER-0202 | planned |
| `POST /admin/users` | USER-0203 | planned |
| `PATCH /admin/users/:id` | USER-0204 | planned |
| `DELETE /admin/users/:id` | USER-0205 | planned |
| `POST /admin/users/:id/restore` | USER-0205 | planned |
| `POST /admin/users/bulk-action` | USER-0206 | planned |
| `PATCH /admin/users/:id/status` | USER-0207 | planned |
| `POST /admin/users/:id/activate` | USER-0207 | planned |
| `POST /admin/users/:id/suspend` | USER-0207 | planned |
| `POST /admin/users/:id/ban` | USER-0207 | planned |
